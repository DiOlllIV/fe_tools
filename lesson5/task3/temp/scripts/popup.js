...
export function clickOnItems() {
  var eventItems = document.querySelectorAll('.calendar-section__item');

  var _iterator = _createForOfIteratorHelper(eventItems),
      _step;
...
;
export var popupActions = function popupActions() {
  openPopup();
  closePopup();
};